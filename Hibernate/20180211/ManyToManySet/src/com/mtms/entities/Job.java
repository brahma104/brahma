...
public class Job implements Serializable {
	...
	protected double offeredSalary;
	protected String location;
	@ManyToMany
	@JoinTable(name = "an_job_skills", joinColumns = { @JoinColumn(name = "job_no") }, inverseJoinColumns = {
	...
	public int hashCode() {
		...
		long temp;
		temp = Double.doubleToLongBits(offeredSalary);
	...
	public boolean equals(Object obj) {
		...
		if (location == null) {
			...
			return false;
		if (Double.doubleToLongBits(offeredSalary) != Double.doubleToLongBits(other.offeredSalary))
			return false;
		if (title == null) {
			if (other.title != null)
				return false;
