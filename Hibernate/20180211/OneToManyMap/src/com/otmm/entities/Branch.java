...
public class Branch implements Serializable {
	...
	protected Map<String, Cheque> clearingCheques;
	...
	public Map<String, Cheque> getClearingCheques() {
		return clearingCheques;
	}

	public void setClearingCheques(Map<String, Cheque> clearingCheques) {
		this.clearingCheques = clearingCheques;
	}
	...
	public String toString() {
		return "Branch [branchNo=" + branchNo + ", bankName=" + bankName + ", branchName=" + branchName + ", location="
				+ location + ", ifscCode=" + ifscCode + ", clearingCheques=" + clearingCheques + "]";
	}
